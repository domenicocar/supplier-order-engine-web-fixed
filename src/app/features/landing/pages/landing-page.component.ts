          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
              <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <span class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100 text-sm font-semibold text-emerald-700">
                  1
                </span>
                <h3 class="mt-4 text-lg font-semibold text-slate-950">Crea ordine</h3>
                <p class="mt-2 text-sm leading-6 text-slate-600">
                  Avvia un nuovo ordine dalla sessione frontend collegata al backend.
                </p>
              </article>
              ...
              <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <h3 class="mt-4 text-lg font-semibold text-slate-950">Import PDF ordine</h3>
                <p class="mt-2 text-sm leading-6 text-slate-600">
                  Carica il PDF e visualizza subito prodotti letti, scarti e review item.
                </p>
              </article>
